...
<article class="col-one justify"><br>
    <h1>Privacy Policy</h1>
        ...
        <p>This page informs you of our policies regarding the collection, use, and disclosure of personal data when you use our Service and the choices you have associated with that data. This Privacy Policy for https://gridcoin.ddns.net is powered by TermsFeed.</p>
        <p>We use your data to provide and improve the Service. By using the Service, you agree to the collection and use of information in accordance with this policy. Unless otherwise defined in this Privacy Policy, terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, accessible from https://gridcoin.ddns.net<br><br></p>
    <h2>Information Collection And Use</h2>
        ...
        <h3>Types of Data Collected</h3>
            <h4>Personal Data</h4>
                ...
                <ul>
                    <li>Cookies and Usage Data<br><br></li>
                </ul>
            <h4>Usage Data</h4>
            ...
            <h4>Tracking &amp; Cookies Data</h4>
                ...
                <ul>
                    ...
                    <li><strong>Security Cookies.</strong> We may use Security Cookies for security purposes.<br><br></li>
                </ul>
    <h2>Use of Data</h2>
        <p>Gridcoin Projects uses the collected data for various purposes:</p>    
        <ul>
            ...
            <li>To detect, prevent and address technical issues<br><br></li>
        </ul>
    <h2>Transfer Of Data</h2>
        ...
        <p>Gridcoin Projects will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information.<br><br></p>
    <h2>Disclosure Of Data</h2><br>
        <h3>Legal Requirements</h3>
            <p>Gridcoin Projects may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
            <ul>
                <li>To comply with a legal obligation</li>
                <li>To protect and defend the rights or property of Gridcoin Projects</li>
                <li>To prevent or investigate possible wrongdoing in connection with the Service</li>
                <li>To protect the personal safety of users of the Service or the public</li>
                <li>To protect against legal liability<br><br></li>
            </ul>
